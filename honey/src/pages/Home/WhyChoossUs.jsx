    ...
    <div className="pt-60">
      <div className="container mx-auto px-4">
        <div className="text-center mb-6">
          <p className="text-[18px] font-medium tracking-wide">{t("whoose.0")}</p>
          <h5 className="text-[32px] font-medium tracking-wide">{t("whoose.1")}</h5>
        </div>
          ...
          <div className="relative group max-w-sm w-full">
            ...
            <div className="relative bg-amber-100 rounded-tl-[80px] rounded-br-[80px] shadow-[8px_10px_20px_#0000000d] px-6 py-8 min-h-[280px] text-left z-10">
              <div className="relative">
                ...
                <h3 className="text-[24px] font-medium tracking-wide pl-[60px] text-amber-600">{t("whoose.2")}</h3>
              </div>
          ...
          <div className="relative group max-w-sm w-full">
            ...
            <div className="relative bg-amber-100 rounded-tl-[80px] rounded-br-[80px] shadow-[8px_10px_20px_#0000000d] px-6 py-8 min-h-[280px] text-left z-10">
              <div className="relative">
                ...
                <h3 className="text-[24px] font-medium tracking-wide pl-[60px] text-amber-600">{t("whoose.4")}</h3>
              </div>
              <p className="mt-4 pl-[60px] text-[16px] text-gray-600 font-medium tracking-wide">
                {t("whoose.5")}
              </p>
          ...
          <div className="relative group max-w-sm w-full">
            ...
            <div className="relative bg-amber-100 rounded-tl-[80px] rounded-br-[80px] shadow-[8px_10px_20px_#0000000d] px-6 py-8 min-h-[280px] text-left z-10">
              <div className="relative">
                ...
                <h3 className="text-[24px] font-medium tracking-wide pl-[60px] text-amber-600">{t("whoose.6")}</h3>
              </div>
              <p className="mt-4 pl-[60px] text-[16px] text-gray-600 font-medium tracking-wide">
                {t("whoose.7")}
              </p>
