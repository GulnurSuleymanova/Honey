    ...
    <div className="pt-60">
      <div className="container mx-auto px-4">
        <div className="text-center mb-6">
          <p className="text-[18px] text-[#5B2800] font-medium tracking-wide">WHY CHOOSE US</p>
          <h5 className="text-[32px] text-[#222222] font-medium tracking-wide">Why Choose Our Products
          </h5>
        </div>
          ...
          <div className="relative group max-w-sm w-full">
            ...
            <div className="relative bg-white rounded-tl-[80px] rounded-br-[80px] shadow-[8px_10px_20px_#0000000d] px-6 py-8 min-h-[280px] text-left z-10">
              <div className="relative">
                ...
                <h3 className="text-[24px] font-medium tracking-wide pl-[60px]">All-Natural and
                  Organic Honey</h3>
              </div>
          ...
          <div className="relative group max-w-sm w-full">
            ...
            <div className="relative bg-white rounded-tl-[80px] rounded-br-[80px] shadow-[8px_10px_20px_#0000000d] px-6 py-8 min-h-[280px] text-left z-10">
              <div className="relative">
                ...
                <h3 className="text-[24px] font-medium tracking-wide pl-[60px]">Honey Traceability and
          ...
          <div className="relative group max-w-sm w-full">
            ...
            <div className="relative bg-white rounded-tl-[80px] rounded-br-[80px] shadow-[8px_10px_20px_#0000000d] px-6 py-8 min-h-[280px] text-left z-10">
              <div className="relative">
                ...
                <h3 className="text-[24px] font-medium tracking-wide pl-[60px]">Professional
                  Beekeepers</h3>
              </div>
              <p className="mt-4 pl-[60px] text-[16px] text-gray-600 font-medium tracking-wide">
                The use of natural honey as a nutraceutical agent is associated with nutritional benefits and therapeutic promises.              </p>
