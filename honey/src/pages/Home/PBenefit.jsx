    ...
    <div className="py-5 relative">
      ...
      <div className="container mx-auto px-4">
        <div className="text-center">
          <h6 className=" text-[28px] font-semibold mt-3">Product Benefits
          </h6>
          <h5 className="text-[45px] font-bold pt-3">Speciality of Honey

          </h5>
          <p className="pt-3 max-w-[600px] mx-auto text-base ">
  ...
  return (
    <div className="pt-8">
      <div className="flex items-center gap-5">
        <p className="text-[17px] font-bold text-right max-w-[200px] mb-0">{text}</p>
        <div className="relative w-[100px] h-[50px] bg-[#eab73f] flex items-center justify-center">
          <span className=" font-bold z-10">{number}</span>
